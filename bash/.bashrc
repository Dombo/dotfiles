...
export BASH_IT="${HOME}/Code/Dombo/dotfiles/bash_it"
...
# Set this so we bash-it sources any custom files we define within this directory with the *.bash extension
export BASH_IT_CUSTOM="${HOME}/Code/Dombo/dotfiles/bash_it_custom"
...
# Add pip installation target directory to PATH
